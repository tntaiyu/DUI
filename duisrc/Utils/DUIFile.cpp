...
//////////////////////////////////////////////////////////
CMemFile::CMemFile(BYTE* pBuffer, DWORD size)
{
	m_pBuffer = pBuffer;
	m_Position = 0;
	m_Size = m_Edge = size;
...
//////////////////////////////////////////////////////////
BYTE* CMemFile::GetBuffer(bool bDetachBuffer)
{
...
//////////////////////////////////////////////////////////
size_t CMemFile::Read(void *buffer, size_t size, size_t count)
{
...
//////////////////////////////////////////////////////////
size_t CMemFile::Write(const void *buffer, size_t size, size_t count)
{
	if (m_pBuffer==NULL) return 0;
	if (buffer==NULL) return 0;
...
//////////////////////////////////////////////////////////
bool CMemFile::Seek(long offset, int origin)
{
...
//////////////////////////////////////////////////////////
bool CMemFile::PutC(unsigned char c)
{
	if (m_pBuffer==NULL) return false;
...
//////////////////////////////////////////////////////////
char * CMemFile::GetS(char *string, int n)
{
	n--;
	long c,i=0;
	while (i<n){
...
//////////////////////////////////////////////////////////
long	CMemFile::Scanf(const char *format, void* output)
{
	return 0;
}
//////////////////////////////////////////////////////////
bool CMemFile::Alloc(DWORD dwNewLen)
{
